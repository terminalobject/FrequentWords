 ...
 * The initial implementation parsed the words into a map using regExs to filter out punctuation
 ...
 * all of which contributed to bringing the execution speed down to ~ 45 seconds from over 220.
 */
public class App 
{
